...
int flashBlinkState = 0; //While in flashing mode, 0 = display off, 1 = display on
int digitCounter = 0;
...
void display7Seg(void)
{
   ...
   //    g - D7
        ...
        */
        ...
        //GOING TO PASS IN MINUTE AND HOUR INSTEAD
       ...
       // getCurrentTime();
        ...
        number = 8; //Get value from RTC time
...
void configuration(void)
{
    ...
    */
    ...
    //       Pins D7, D8, D9, D10, D11 are recommended for multiplexing the LED display.GPIO_StructInit( &GPIOInitStruct );
        ...
        GPIO_StructInit( &GPIOInitStruct );
        GPIOInitStruct.GPIO_Pin = GPIO_Pin_10 |GPIO_Pin_8;
        GPIOInitStruct.GPIO_Speed = GPIO_Speed_2MHz;
        GPIOInitStruct.GPIO_Mode = GPIO_Mode_OUT;
        GPIOInitStruct.GPIO_OType = GPIO_OType_PP;
        GPIOInitStruct.GPIO_PuPd = GPIO_PuPd_NOPULL;
